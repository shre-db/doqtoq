...
from backend.utils import is_query_off_topic, is_potential_prompt_injection
...
class TestDocumentRAG:
    ...
    def test_rag_initialization(self, mock_chunk, mock_vectorstore, mock_llm, sample_txt_path):
